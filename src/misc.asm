;
; Title:	AGON Electron OS - Miscellaneous helper functions
...
_exec16:		
			...
			out0 (RAM_ADDR_U), a ; MSM: map internal ram to upper 4k of selected 64kB
			LD	HL, (IY+9)	; Load HLU with the pointer to the params			
;
...
; Wait for timer1 to hit 0
;
__wait_timer1:
_wait_timer1:		PUSH	AF 
			PUSH	BC 
			IN0	A, (TMR1_CTL)	; Enable the timer
			OR	3
			OUT0	(TMR1_CTL), A
$$:			IN0	B, (TMR1_DR_L)	; Fetch the counter L
			IN0 	A, (TMR1_DR_H)	; And the counter H
			OR	B 
			JR	NZ, $B
			POP	BC 
			POP	AF 
