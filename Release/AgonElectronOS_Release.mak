...
#
# ZDS II Make File - AgonElectronOS project, Release configuration
#
...
WORKDIR = Z:\Development\AgonLight\software\AgonElectronOS\Release
WORKDIR_ESCSPACE = Z:\Development\AgonLight\software\AgonElectronOS\Release

# output files directory
OUTDIR = Z:\Development\AgonLight\software\AgonElectronOS\Release\
OUTDIR_ESCSPACE = Z:\Development\AgonLight\software\AgonElectronOS\Release\
...
CFLAGS =  \
-define:NDEBUG -define:_EZ80 -define:_EZ80F92  \
...
-NOmultithread -NOpadbranch -NOdebug -cpu:eZ80F92  \
-asmsw:"   \
	-define:_EZ80ACCLAIM!=1 -define:NDEBUG=1 -define:_SIMULATE=1  \
...
LDFLAGS = @.\AgonElectronOS_Release.linkcmd
...
deltarget: 
	@if exist "$(WORKDIR)\mos_electronhal.lod"  \
            $(RM) "$(WORKDIR)\mos_electronhal.lod"
	@if exist "$(WORKDIR)\mos_electronhal.hex"  \
            $(RM) "$(WORKDIR)\mos_electronhal.hex"
	@if exist "$(WORKDIR)\mos_electronhal.map"  \
            $(RM) "$(WORKDIR)\mos_electronhal.map"
...
clean: 
	...
	@if exist "$(WORKDIR)\joystick.lis"  \
            $(RM) "$(WORKDIR)\joystick.lis"
	@if exist "$(WORKDIR)\joystick.lst"  \
            $(RM) "$(WORKDIR)\joystick.lst"
...
$(WORKDIR_ESCSPACE)\main.obj :  \
            ...
            $(PRJDIR_ESCSPACE)\include\joysticks.h  \
...
$(WORKDIR_ESCSPACE)\joystick.obj :  \
            $(PRJDIR_ESCSPACE)\src\joystick.asm  \
            $(INCLUDE_ESCSPACE)\zilog\ez80F92.inc  \
            $(PRJDIR_ESCSPACE)\src\equs.inc  \
            $(PRJDIR_ESCSPACE)\src\macros.inc
	 $(AS) $(ASFLAGS) "$(PRJDIR)\src\joystick.asm"
