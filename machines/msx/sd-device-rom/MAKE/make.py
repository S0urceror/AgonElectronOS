            ...
            if len(tokens) > 0:
                ...
                if not key[0] == ';':
                    ...
                    if key == 'PROJECT_TYPE':
                        ...
                        rdh_s = rdh_s + '.globl		            _onDevice{}_OPEN\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_CLOSE\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_RANDOM_ACCESS\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_OUTPUT\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_INPUT\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_LOC\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_LOF\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_EOF\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_FPOS\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_BACKUP_CHAR\n'.format(value)
                        rdh_s = rdh_s + '.globl		            _onDevice{}_INIT\n'.format(value)
                        rdh_s = rdh_s + 'device_{}::\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_OPEN\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_CLOSE\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_RANDOM_ACCESS\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_OUTPUT\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_INPUT\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_LOC\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_LOF\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_EOF\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_FPOS\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_BACKUP_CHAR\n'.format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_INIT\n'.format(value)
                        rdh_s = rdh_s + ".asciz		            '{}'\n".format(value)
                        rdh_s = rdh_s + '.dw		            _onDevice{}_INIT\n'.format(value)
                    else:
                        if value.lower() == '_off':
...
def buildSymbolFile():
    ...
    execute (VAR['DBG_CALL3'], f'python3 "{exe}" {VAR["PROJECT_TYPE"]} "{VAR["MSX_OBJ_PATH"]}\" "{VAR["MSX_FILE_NAME"]}" {VAR["SYMBOL_DETAIL"]}')
